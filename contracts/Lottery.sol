...
contract Lottery is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    */
    ...
    function checkUpkeep(
        bytes memory /*calldata checkData*/ // Calldata doesn't work with strings so we changed it to memory
    ) /*external*/ public view override returns (bool upkeepNeeded, bytes memory /*performData*/) {
